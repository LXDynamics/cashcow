...
- [x] Create ` ~/cashcow/pyproject.toml` with Poetry configuration
...
- [x] Create ` ~/cashcow/src/cashcow/models/base.py`:
  ```python
  ...
  class BaseEntity(BaseModel):
      ...
      def parse_dates(cls, v):
          ...
          return v
  ```
- [x] Create entity type models in ` ~/cashcow/src/cashcow/models/entities.py`
...
- [x] Create ` ~/cashcow/src/cashcow/storage/database.py`:
  ```python
  ...
  ```
- [x] Implement YAML loader in ` ~/cashcow/src/cashcow/storage/yaml_loader.py`
...
- [x] Create ` ~/cashcow/config/settings.yaml`:
  ```yaml
  cashcow:
    version: 1.0
    database: cashcow.db
    ...
    kpis:
      ...
      - rd_percentage
  ```
- [x] Create config loader in ` ~/cashcow/src/cashcow/config.py`
...
#### Employee Entity
- [x] Create ` ~/cashcow/src/cashcow/models/employee.py`
- [x] Implement salary, equity, overhead calculations
- [x] Create example: ` ~/cashcow/entities/expenses/employees/example-employee.yaml`

#### Revenue Entities
- [x] Create ` ~/cashcow/src/cashcow/models/revenue.py` with Grant, Investment, Sales, Service classes
- [x] Create examples in ` ~/cashcow/entities/revenue/*/`

#### Expense Entities
- [x] Create ` ~/cashcow/src/cashcow/models/expense.py` with Facility, Software, Equipment classes
- [x] Create examples in ` ~/cashcow/entities/expenses/*/`

#### Project Entity
- [x] Create ` ~/cashcow/src/cashcow/models/project.py` with milestone tracking
- [x] Create example in ` ~/cashcow/entities/projects/`

### Task 2.2: Calculator Plugin System
- [x] Create ` ~/cashcow/src/cashcow/engine/calculators.py`:
  ```python
  ...
  class CalculatorRegistry:
      ...
      def register(self, entity_type: str, name: str):
          ...
          return decorator
  ```
- [x] Implement built-in calculators in ` ~/cashcow/src/cashcow/engine/builtin_calculators.py`

### Task 2.3: Validation Framework
- [x] Create ` ~/cashcow/src/cashcow/validation.py`
...
- [x] Create ` ~/cashcow/src/cashcow/engine/cashflow.py`:
  ```python
  import asyncio
  from datetime import date
  import pandas as pd
...
- [x] Create ` ~/cashcow/src/cashcow/cli/main.py`:
  ```python
  import click
...
### Unit Tests
- [x] Test calculators: ` ~/cashcow/tests/test_calculators.py`
- [x] Test models: ` ~/cashcow/tests/test_models.py`
- [x] Test storage: ` ~/cashcow/tests/test_storage.py`

### Integration Tests
- [x] End-to-end forecast: ` ~/cashcow/tests/test_integration.py`
- [x] Scenario application: ` ~/cashcow/tests/test_scenarios.py`
- [x] Report generation: ` ~/cashcow/tests/test_reports.py`

### Performance Tests
- [x] Large dataset handling: ` ~/cashcow/tests/test_performance.py`
- [x] Parallel calculation benchmarks: ` ~/cashcow/tests/test_parallel_benchmarks.py`
- [x] Memory usage profiling: ` ~/cashcow/tests/test_memory_profiling.py`
