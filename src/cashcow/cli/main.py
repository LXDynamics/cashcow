...
@click.option('--type', 'entity_type', 
              type=click.Choice(['employee', 'grant', 'investment', 'sale', 'service', 'facility', 'software', 'equipment', 'project']),
              required=True,
...
def forecast(months: int, scenario: str, start_date: Optional[datetime], 
             output_format: str, output: Optional[str], kpis: bool):
...
def kpi(months: int, scenario: str, alerts: bool):
